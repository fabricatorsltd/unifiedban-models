...
{
    public partial class ubnextFirst : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AcceptedValues = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UBChatConfiguration", x => new { x.ChatId, x.ConfigurationParameterId, x.Platforms });
                    table.ForeignKey(
                        name: "FK_UBChatConfiguration_UBChat_ChatId",
                        column: x => x.ChatId,
                        principalSchema: "dbo",
                        principalTable: "UBChat",
                        principalColumn: "UBChatId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UBUserId = table.Column<string>(type: "nvarchar(40)", nullable: true),
